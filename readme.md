...
- Rode o comando "php artisan migrate:refresh", irá criar todas as tabelas no seu banco de dados automaticamente, sem precisar importar o arquivo.
...
Será aceita somente imagem JPG no upload da imagem no cadastro da notícia.
